...
$data = ["href"=>"$href", "logo" => "$logo", "email" => "$customerEmail", "title" => "$customerName", "content" => "$customerMessage"];
?>
    ...
    <div class="email-container">
        ...
        <div class="content">
                ...
                <div class="hero-section">
                    <p class="hero-sendertitle">From: <?=$data["email"]?> </p>
                    <h1 class="hero-title"><?=$data["title"]?></h1>
                    <p class="hero-subtitle"><?=$data["content"]?></p>
                </div>
